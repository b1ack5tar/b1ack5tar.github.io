...
> 你可以轻易爆破我们的系统，但是一个不可泄露的"canary"你又该如何应对？<br>
> 你可能需要使用 Python `ctypes` 包来直接调用 C 库函数。<br>
...
![](/assets/img/posts/moectf-2025-pwn-boom/1.png){: .normal }

### boom_revenge

![](/assets/img/posts/moectf-2025-pwn-boom/2.png){: .normal }

两个程序都包含可直接利用的 `shell` 函数：

![](/assets/img/posts/moectf-2025-pwn-boom/3.png){: .normal }

![](/assets/img/posts/moectf-2025-pwn-boom/4.png){: .normal }
...
![](/assets/img/posts/moectf-2025-pwn-boom/5.png){: .normal }
...
![](/assets/img/posts/moectf-2025-pwn-boom/6.png){: .normal }
